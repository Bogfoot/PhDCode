/* @brief This is a simple application for testing IIC communication on
* a RedPitaya
...
/*
*     * Load the offset address inside EEPROM where data
*     need to be written.
...
*     * Limit data size per transmission is PAGESIZE */
  ...
  * */
  ...
  /* ** Load the offset *address inside EEPROM *where data need to be *written.  ** Supported for *BigEndian and *LittleEndian *CPU's **/ 
    write_buffer[0] = (uint8_t)(offset >> 8);
    write_buffer[1] = (uint8_t)(offset);
