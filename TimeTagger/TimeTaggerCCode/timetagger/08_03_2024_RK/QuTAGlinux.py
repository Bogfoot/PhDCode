...
class QuTAG:
    ...
    def __init__(self):
        ...
        if platform.system() == "Windows":
            ...
            # load DLL -------------------------------------------
            self.tdclib = ctypes.windll.LoadLibrary(full_path + os.path.sep + dll_name)

        if platform.system() == "Linux":
            self.tdclib = ctypes.cdll.LoadLibrary(
                "/home/bogfootlj/Documents/PhDCode/TimeTagger/TimeTaggerCCode/timetagger/08_03_2024_RK/libtdcbase.so"
            )
            self.coincLib = ctypes.cdll.LoadLibrary(
                "/home/bogfootlj/Documents/PhDCode/TimeTagger/TimeTaggerCCode/timetagger/08_03_2024_RK/qutag_histogram.so"
            )
    ...
    def declareAPI(self):
        ...
        self.coincLib.determineCoincidencesSimple.argtypes = [
            ctypes.POINTER(ctypes.c_int64),
            ctypes.POINTER(ctypes.c_int8),
            ctypes.c_int64,
            ctypes.c_int64,
        ...
        self.coincLib.determineCoincidencesSimple.restype = ctypes.c_int64

        self.coincLib.countSingles.argtypes = [
            ctypes.POINTER(ctypes.c_int64),
            ctypes.POINTER(ctypes.c_int8),
            ctypes.c_int64,
            ctypes.c_int8,
        ]
        self.coincLib.countSingles.restype = ctypes.c_int64

        self.coincLib.determineCoincidencesSimpleHz.argtypes = [
            ctypes.POINTER(ctypes.c_int64),
            ctypes.POINTER(ctypes.c_int8),
            ctypes.c_int64,
            ctypes.c_int64,
        ...
        self.coincLib.determineCoincidencesSimpleHz.restype = ctypes.c_double

        self.coincLib.countSinglesHz.argtypes = [
            ctypes.POINTER(ctypes.c_int64),
            ctypes.POINTER(ctypes.c_int8),
            ctypes.c_int64,
            ctypes.c_int8,
        ]
        self.coincLib.countSinglesHz.restype = ctypes.c_double
