...
# Let's set parameters for the internally generated start stop histograms: bin width in ps (range = 1 ... 1000000, default = 1) & bin count (range = 2 ... 1000000, default = 10000)
