...
class QuTAG:
    ...
    def __init__(self):
        ...
        print(
            "Initialize and Start with quTAG device: ", self.err_dict[self.Initialize()]
        )
    ...
    def __declareAPI(self):
        ...
        self.qutools_dll.TDC_getChannelDelay.argtypes = [
            ctypes.c_int32,
            ctypes.POINTER(ctypes.c_int32),
        ]
        ...
        self.qutools_dll.TDC_getClockState.argtypes = [
            ctypes.POINTER(ctypes.c_int32),
            ctypes.POINTER(ctypes.c_int32),
        ]
    ...
    def getClockState(self):
        ...
        ans = self.qutools_dll.TDC_getClockState(
            ctypes.byref(locked), ctypes.byref(uplink)
        )
    ...
    def getChannelsEnabled(self):
        ...
        ans = self.qutools_dll.TDC_getChannelsEnabled(
            ctypes.byref(channelStart), ctypes.byref(channelMask)
        )
