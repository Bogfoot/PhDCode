...
coincWin, coincWin, expTime = qutag.getDeviceParams()
...
qutag.enableChannels(
    True, #11101001
)  # Disables start channel and enables only stop channels 1, 4, 6, 7, 8 - all other stop channels are disabled
