#!/usr/bin/python
5.
from PyQt5.QtWidgets import QApplication, QMainWindow, QPushButton, QWidget, QLineEdit, QSpinBox, QLabel
...
class StartWindow(QMainWindow):
  def __init__(self, camera = None):
    ...
    self.DXspinBox = QSpinBox(self.central_widget)
    self.DXspinBox.setObjectName("DXspinBox") 
    self.DYspinBox = QSpinBox(self.central_widget)
    self.DYspinBox.setObjectName("DYspinBox") 
    self.XspinBox = QSpinBox(self.central_widget)
    self.XspinBox.setObjectName("XspinBox") 
    self.YspinBox = QSpinBox(self.central_widget)
  ...
  def update_image(self):
    ...
    (QuadX, QuadY) = self.camera.getQuad(np.array((self.Xcenter, self.Ycenter)))
